...
public class CourseDbContext : DbContext
{
    ...
    private static IEnumerable<Semester> CreateSemesters()
    {
        return new[]
        {
            new Semester { SemesterId = 1, SemesterName = "Spring 2025", StartDate = new DateTime(2025, 1, 6), EndDate = new DateTime(2025, 4, 27) },
            new Semester { SemesterId = 2, SemesterName = "Summer 2025", StartDate = new DateTime(2025, 5, 5), EndDate = new DateTime(2025, 8, 24) },
            new Semester { SemesterId = 3, SemesterName = "Fall 2025", StartDate = new DateTime(2025, 9, 1), EndDate = new DateTime(2025, 12, 21) },
            new Semester { SemesterId = 4, SemesterName = "Spring 2026", StartDate = new DateTime(2026, 1, 5), EndDate = new DateTime(2026, 4, 26) },
            new Semester { SemesterId = 5, SemesterName = "Summer 2026", StartDate = new DateTime(2026, 5, 4), EndDate = new DateTime(2026, 8, 23) }
        };
    }
